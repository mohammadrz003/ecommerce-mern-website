  ...
  return (
    <Layout>
      <Header className="justify-between">
        <Link to="/" className="px-5 flex font-semibold py-6 lg:px-10 border border-gray-200 items-center space-x-3">
          <svg
        ...
        <div className="flex items-center divide-x divide-gray-200 border-x border-b border-gray-200">
          <button className="px-5 font-semibold py-6 lg:px-10">SHARE THIS</button>
